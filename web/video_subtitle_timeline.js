...
function addStyles() {
    ...
    style.textContent = `
      ...
      .cs-subtitle-style-grid { display:grid; grid-template-columns:minmax(230px,1.35fr) repeat(3,minmax(150px,1fr)); gap:9px; }
      ...
      .cs-subtitle-typography-fields { grid-template-columns:minmax(0,1fr) minmax(0,1fr); }
      ...
      .cs-subtitle-outline-fields,.cs-subtitle-shadow-fields { grid-template-columns:minmax(0,1fr); }
